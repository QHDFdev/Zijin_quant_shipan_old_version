...
Showbo.Msg={  
    ...
    InitMsg:function(width){
      ...
      html='<div class="top"><div class="right">'+'<i class="fa fa-remove btn-xs" id="shan" style="display: none"></i>'+
...
//    	  '<div class="avtar"><img src="images/avtar.png"></div>'+
    ...
    confirm:function(msg,fn){  
      ...
      this.show({buttons:{yes:'确认',no:'取消'},msg:msg,title:'确认',fn:fn});
    },  
    ...
    onResize:function(isResize){  
       ...
       if(Showbo.BodyScale.tx <=500){
         Showbo.Msg.dvMsgBox.style.width='60%';
       }
       else if(Showbo.BodyScale.tx <=768){
//    	   alert("height: " +  document.documentElement.clientHeight);
    	   Showbo.Msg.dvMsgBox.style.width='50%';
    	   // Showbo.Msg.dvMsgBox.style.height='400px';
       }else if(Showbo.BodyScale.tx <=992){
    	   Showbo.Msg.dvMsgBox.style.width='40%';
    	   // Showbo.Msg.dvMsgBox.style.height='400px';
       }else if(Showbo.BodyScale.tx <=1200){
    	   Showbo.Msg.dvMsgBox.style.width='40%';
    	   // Showbo.Msg.dvMsgBox.style.height='400px';
       }else{
    	   Showbo.Msg.dvMsgBox.style.width='22%';
    	   // Showbo.Msg.dvMsgBox.style.height='400px';
       }
