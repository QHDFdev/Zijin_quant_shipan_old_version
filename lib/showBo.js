...
Showbo.Msg={  
    ...
    InitMsg:function(width){
      ...
      html='<div class="top"><div class="right">'+
    	  '<div class="head-info"><label class="lbl-1"> </label> <label class="lbl-2"> </label><label class="lbl-3"> </label></div>'+
    	  '<div class="title" id="dvMsgTitle"></div></div></div>'+ 
        '<div class="body"><div class="right">'+
        '<br/><br/>'+
//    	  '<div class="avtar"><img src="images/avtar.png"></div>'+
    	  '<div><i class="fa icon-info-sign fa-5x" style="color:#f1c85f;"></i><div>'+
    	  '<div class="ct" id="dvMsgCT"></div></div></div>'+  
    ...
    alert:function(msg){  
      this.show({buttons:{yes:'确认'},msg:msg,title:'消&nbsp;息'});
    },  
    ...
    show:function(cfg){  
      ...
      if(cfg.wait){  
        ...
        this.dvBottom.style.height='100px';
        ...
        if(cfg.buttons.no)this.dvBtns.prepend(this.createBtn('no',cfg.buttons.no,cfg.fn));
      }  
    ...
    onResize:function(isResize){  
       ...
       if(Showbo.BodyScale.tx <=768){
//    	   alert("height: " +  document.documentElement.clientHeight);
    	   Showbo.Msg.dvMsgBox.style.width='100%';
    	   Showbo.Msg.dvMsgBox.style.height='400px';
       }else if(Showbo.BodyScale.tx <=992){
    	   Showbo.Msg.dvMsgBox.style.width='50%';
    	   Showbo.Msg.dvMsgBox.style.height='400px';
       }else if(Showbo.BodyScale.tx <=1200){
    	   Showbo.Msg.dvMsgBox.style.width='45%';
    	   Showbo.Msg.dvMsgBox.style.height='400px';
       }else{
    	   Showbo.Msg.dvMsgBox.style.width='33.333333%';
    	   Showbo.Msg.dvMsgBox.style.height='400px';
       }
        //Showbo.Msg.lightBox.style.
